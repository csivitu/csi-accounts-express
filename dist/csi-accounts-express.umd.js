(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('crypto'), require('buffer'), require('stream'), require('util')) :
	typeof define === 'function' && define.amd ? define(['crypto', 'buffer', 'stream', 'util'], factory) :
	(global.csiAccountsExpress = factory(global.crypto,global.buffer,global.stream,global.util));
}(this, (function (crypto,buffer,stream,util) { 'use strict';
	...
	var authorize = function (options) {
	    return function (req, res, next) {
	        ...
	        try {
	            req.user = jsonwebtoken.verify(token, options.secret);
...
//# sourceMappingURL=csi-accounts-express.umd.js.map
